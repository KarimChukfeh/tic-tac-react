  ...
  return (
    ...
    >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:static md:z-auto t2-dashboard-dock">
        ...
        >
          <GamesCard routeGeneration="v3" currentGame="chess" onHeightChange={setGamesCardHeight} isExpanded={expandedPanel === 'games'} onToggleExpand={() => setExpandedPanel(expandedPanel === 'games' ? null : 'games')} />
