/**
 * UserManualV2 - V2 copy of the V1 TicTacToe user manual.
 *
 * This starts the V1/V2 documentation split by giving V2 its own copy
 * of the current manual content so it can evolve independently.
 */
