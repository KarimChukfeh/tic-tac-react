...
export const CONNECTFOUR_V2_FACTORY_ADDRESS = sharedContracts.FACTORY_ADDRESS;
export const CONNECTFOUR_V2_FACTORY_ABI = sharedContracts.FACTORY_ABI;
export const CONNECTFOUR_V2_INSTANCE_ABI = sharedContracts.INSTANCE_ABI;
export const CONNECTFOUR_V2_IMPLEMENTATION_ADDRESS = sharedContracts.IMPLEMENTATION_ADDRESS;
export const CONNECTFOUR_V2_FACTORY_ADDRESS_CANDIDATES = sharedContracts.FACTORY_ADDRESS_CANDIDATES;
