/**
 * ConnectFour2 - On-Chain Connect Four Tournament Frontend
 *
 * SETUP INSTRUCTIONS:
 *
...
export default function ConnectFour2() {
                        ...
                        <div key={tierId} className="mb-6">
                          ...
                          >
                            <h3 className="text-2xl font-bold text-purple-400 flex items-center gap-2 flex-wrap">
                              ...
                              <span className="text-sm font-normal text-purple-300">• {getEstimatedDuration('connectfour', metadata.playerCount)}</span>
                              <ChevronDown
                                size={24}
