      ...
      <div className="flex flex-wrap items-center justify-center gap-3 text-center">
        {account ? (
          ...
          <div className="relative flex items-center gap-2" ref={tooltipRef}>
            ...
            {isTooltipOpen && (
              <div
                className="absolute left-1/2 top-full z-20 mt-3 w-[300px] max-w-[calc(100vw-2rem)] -translate-x-1/2 rounded-xl border border-cyan-400/30 bg-slate-950/95 p-4 text-left shadow-2xl shadow-cyan-500/10 backdrop-blur-md"
                onMouseEnter={() => setIsTooltipOpen(true)}
                onMouseLeave={() => setIsTooltipOpen(false)}
              >
